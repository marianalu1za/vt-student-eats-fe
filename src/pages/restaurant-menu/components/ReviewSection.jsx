...
function ReviewSection({ restaurantId, reviews: propReviews = [], overallRating: propOverallRating = 4.7, totalRatings: propTotalRatings = 100, publicReviews = 20 }) {
  ...
  const displayReviews =
    reviews.length > 0
      ...
      : propReviews.length > 0
        ? mapApiReviewsToDisplayFormat(propReviews)
        : []
